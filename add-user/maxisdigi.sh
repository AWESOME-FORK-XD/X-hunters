...
patchtls=/nakata-vmesswstls
patchnontls=/nakata-vmesswsntls
...
patchtls=/nakata-vlesswstls
patchnontls=/nakata-vlesswsntls
uuid=$(cat /proc/sys/kernel/random/uuid)
read -p "   Bug Address (Example: www.google.com) : " address
read -p "   Bug SNI/Host (Example : m.facebook.com) : " sni
read -p "   Expired (days) : " masaaktif
...
patchtls=/nakata-trojanwstls
patchnone=/nakata-trojanwsntls
read -p "   Bug Address (Example: www.google.com) : " address
