...
#Open HTTP Puncher By NAKATAVPN
...
cd 
wget -O /usr/local/bin/ohp "https://raw.githubusercontent.com/${GitUser}/X-hunters/main/ohp"
...
setenv FRIENDLY_NAME "NAKATAVPN OHP"
...
[Unit]
Description=Direct Squid Proxy For OpenVPN TCP By NAKATAVPN
