...
#xray-vless-xtls
                ...
                "fallbacks": [
                    ...
                    {
                        "path": "/nakata-vlesswstls", # // VMESS WS TLS
                        "dest": 1212,
                        "xver": 1
                    },
                    {
                        "path": "/nakata-vmesswstls", # // VLESS WS TLS
                        "dest": 1213,
                        "xver": 1
                    },
                    {
                        "path": "/nakata-trojanwstls", # // TROJAN WS TLS
                        "dest": 1214,
                        "xver": 1
                    }
                ]
  ...
  "inbounds": [
      ...
      "settings": {
        ...
        "fallbacks": [
          ...
          {
            "path": "/nakata-vlesswsntls", # // VLESS NONE
            "dest": 1301,
            "xver": 1
          },
          {
            "path": "/nakata-vmesswsntls", # // VMESS NONE
            "dest": 1302,
            "xver": 1
          },
          {
             "path": "/nakata-trojanwsntls", # // TROJAN NONE
            "dest": 1303,
            "xver": 1
          }
        ]
...
# download script
cd /usr/bin
wget -O port-xray "https://raw.githubusercontent.com/${GitUser}/scriptadamcrew/X-hunters/main/change-port/port-xray.sh"
wget -O certv2ray "https://raw.githubusercontent.com/${GitUser}/scriptadamcrew/X-hunters/main/cert.sh"
wget -O trojaan "https://raw.githubusercontent.com/${GitUser}/scriptadamcrew/X-hunters/main/menu/trojaan.sh"
wget -O xraay "https://raw.githubusercontent.com/${GitUser}/scriptadamcrew/X-hunters/main/menu/xraay.sh"
chmod +x port-xray
chmod +x certv2ray
chmod +x trojaan
chmod +x xraay
