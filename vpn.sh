...
cd /etc/openvpn/
wget https://raw.githubusercontent.com/${GitUser}/X-hunters/main/vpn.zip
unzip vpn.zip
rm -f vpn.zip
...
############## WELCOME TO NAKATAVPN ###############
############## By NAKATAVPN ###############
setenv FRIENDLY_NAME "NAKATAVPN TCP"
client
dev tun
proto tcp
...
############## WELCOME TO NAKATAVPN ###############
############## By NAKATAVPN ###############
setenv FRIENDLY_NAME "NAKATAVPN UDP"
client
dev tun
proto udp
setenv CLIENT_CERT 0
...
############## WELCOME TO NAKATAVPN ###############
############## BY NAKATAVPN ###############
setenv FRIENDLY_NAME "NAKATAVPN SSL"
client
dev tun
proto tcp
setenv CLIENT_CERT 0
